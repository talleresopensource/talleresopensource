---
title: "Encuesta Julio-Agosto 2020"
date: "`r Sys.Date()`"
...
df <- read_csv("2020-07_encuesta_inicial.csv")


df %>%
  select(`Marca temporal`, starts_with("Selecc")) %>%
...
En base a estas respuestas decidimos diagramar el primer ciclo de talleres open source!